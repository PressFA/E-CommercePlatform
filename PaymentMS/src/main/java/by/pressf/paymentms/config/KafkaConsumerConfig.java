...
public class KafkaConsumerConfig {
    ...
    */
    ...
    @Bean // Бин-kafkaTemplate для отправки сообщений (не транзакционно, т.к producerFactoryDlt)
    ...
    @Bean // Бин-продюсер, который настроен на отправку сообщений не транзакционно
