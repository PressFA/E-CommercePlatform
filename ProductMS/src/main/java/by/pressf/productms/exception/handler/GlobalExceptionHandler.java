package by.pressf.productms.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ProductOverflowException.class)
    public ResponseEntity<?> handleOverflow(ProductOverflowException ex) {
        log.error(ex.getMessage());
